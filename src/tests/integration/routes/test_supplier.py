...
class TestSupplier:
    def test_supplier_endpoint_returns_all_supplier_data(self, client, supplier):
        """
    ...
    def test_supplier_endpoint_returns_a_specific_supplier(self, client, supplier):
        """
        GIVEN the supplier endpoint
    ...
    def test_supplier_endpoint_shows_error_on_incorrect_id(self, client, supplier):
        """
        GIVEN the supplier endpoint
